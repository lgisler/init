...
SOURCE_DIR="/mnt/aaedf42a-2ca7-4440-a78f-958cefb589fb/immich/library/"
BORG_REPO="/home/luis/apps/immich-app/immich-borgbackup"
RCLONE_REMOTE="proton:backup/immich-borgbackup"

# Configuration (defaults)
BACKUP_NAME=$(date +%Y-%m-%d_%H%M%S)
LOG_DIR="/home/luis/apps/immich-app/logs"
